...
ggplot(total_df_filtered_proBLMSO, aes(x= Political_alignment_rating, y = Empathy_score, fill = Political_alignment_rating)) +
...
ggplot(total_df_filtered_antiBLMSO, aes(x= Political_alignment_rating, y = Empathy_score, fill = Political_alignment_rating)) +
  stat_summary(fun.y = mean,
               geom = "bar",
               width = 0.6) +
  stat_summary(fun.data = mean_se,
...
ggplot(total_df_filtered, aes(x= Political_alignment_rating, y = Empathy_score, color = SO_BLM_role)) +
  stat_summary(fun.y = mean,
               geom = "point",
               width = 0.6) +
  stat_summary(fun.data = mean_se,
  ...
  scale_color_manual(name = "BLM-related figures' role\nin the BLM movement",
                         ...
                         values = c("pro-BLM-SO" = "blue", 
                                    "anti-BLM-SO" = "red")) +
  labs(x = "Political alignment rating of news source", y = "Mean empathy score towards pro- and anti-BLM figures", title = "Mean Empathy Score Towards BLM-related Figures in News Media with \nDifferent Political Alignment - with SE Error Bars" ) +
  theme_minimal()
...
#  expand_limits(y = c(0.5, 0.5)) +
  scale_color_manual(name = "BLM-related figures' role\nin the BLM movement",
                         ...
                         values = c("pro-BLM-SO" = "blue", 
                                    "anti-BLM-SO" = "red")) +
  labs(x = "Mean empathy score by conservative news sources", y = "Mean empathy score by liberal news sources", title = "Mean Empathy Score Towards BLM-related Figures in News Media" ) +
  theme_minimal()
...
ggplot(total_df_filtered_forplot_main, aes(x = SO_BLM_role, y = Empathy_score, color = SO_BLM_role)) +
  ...
  labs(x = "BLM-related figures' role in the BLM movement", y = "Mean empathy score in news reporting", title = "Main Effect of BLM-related Figures Pro- or Anti-BLM Role on\nEmpathy Score with SE Error Bars" ) +
  theme_minimal()
